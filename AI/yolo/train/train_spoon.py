...
path = os.path.abspath(os.path.join(current_dir, '..', 'dataset', 'ObjectDetection-2'))
save_path = os.path.abspath(os.path.join(current_dir, '..', 'model', 'spoon.pt'))
save_path2 = os.path.abspath(os.path.join(current_dir, '../..', 'flask', 'model', 'spoon.pt'))
