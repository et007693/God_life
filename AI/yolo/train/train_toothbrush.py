...
path = os.path.abspath(os.path.join(current_dir, '..', 'dataset', 'sikat-gigi-model-1'))
save_path = os.path.abspath(os.path.join(current_dir, '..', 'model', 'toothbrush.pt'))
save_path2 = os.path.abspath(os.path.join(current_dir, '../..', 'flask', 'model', 'toothbrush.pt'))
