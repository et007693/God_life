...
path = os.path.abspath(os.path.join(current_dir, '..', 'dataset', 'dataset_monitor-1'))
save_path = os.path.abspath(os.path.join(current_dir, '..', 'model', 'monitor.pt'))
save_path2 = os.path.abspath(os.path.join(current_dir, '../..', 'flask', 'model', 'monitor.pt'))
