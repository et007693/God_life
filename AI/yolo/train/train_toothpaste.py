...
path = os.path.abspath(os.path.join(current_dir, '..', 'dataset', 'toothpaste-1'))
save_path = os.path.abspath(os.path.join(current_dir, '..', 'model', 'toothpaste.pt'))
save_path2 = os.path.abspath(os.path.join(current_dir, '../..', 'flask', 'model', 'toothpaste.pt'))
