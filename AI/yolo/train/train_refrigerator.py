...
path = os.path.abspath(os.path.join(current_dir, '..', 'dataset', 'WeeeTest2-1'))
save_path = os.path.abspath(os.path.join(current_dir, '..', 'model', 'refrigerator.pt'))
save_path2 = os.path.abspath(os.path.join(current_dir, '../..', 'flask', 'model', 'refrigerator.pt'))

if not os.path.exists(path):
  rf = Roboflow(api_key="pSKVxTiuweLONzMDubjk")
  project = rf.workspace("testworkplace").project("weeetest2")
