...
import { usePersonalExerciseMissionPage } from '../hooks/usePersonalExerciseMissionPage';

const PersonalExerciseMissionPage = () => {
  const {center,lat,lng,distance,setMoveLine,limitDistance,handleSubmit} = usePersonalExerciseMissionPage();
  return (
<div className="w-screen h-real-screen" id="screen-shot-div">
      ...
      <Map center={center} level={3} className="w-full h-full" draggable={false} zoomable={false}>
        <Polyline
...
export default PersonalExerciseMissionPage