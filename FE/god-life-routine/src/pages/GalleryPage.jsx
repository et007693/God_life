...
const GalleryPage = () => {
  ...
  const {data, isFetching,isFetchingNextPage,isLoading, fetchNextPage} = useInfiniteQuery(
    {
  ...
  return (
      ...
      <div>
      <div className="flex bg-white bg-opacity-50 fixed w-full justify-between items-center px-4 py-2">
        <Header></Header>
        <div className="text-center">
          <p className="text-sm font-semibold mb-2">이달의 성공률</p>
          <div className="bg-white shadow-md rounded-lg p-2">
            <span className="text-xl font-bold text-orange-500">{successRate}%</span>
          </div>
        </div>
      </div>
      <div
